...
const brainrotData = [
  ...
  },
  {
      "term": "Cooked",
      "definition": [
        "'Let him cook' implies someone is in the process of succeeding or showing potential.",
  ...
  },
  {
      "term": "Fanum Tax",
      "definition": [
        "When you take a portion of someone else's food (like the IRS with real money). This term comes from the Twitch streamer Fanum, who routinely takes part of the food his roommate and fellow streamer Kai Cenat order for takeout.",
  ...
  {
      "term": "Gatekeeping",
      "definition": "Withholding information that someone asks of you. Just like a guard at a castle 'gate-keeps' the castle (the info), you are guarding the info.",
      "examples": [
        "I’m gatekeeping."
      ],
  },
  ...
  {
      "term": "Ipad Kid",
      "definition": "Used to describe a type of behavior similar to that of young children who excessively use iPads. This includes drooling, messy eating, and using iPads/phones during social gatherings instead of socializing. Note that a teenager using their phone at a social gathering is not in itself 'Ipad Kid' behavior; it preludes to the childish behavior associated with usage.",
      "examples": [
  ...
  },
  {
      "term": "Impostor",
      "definition": [
        "A term coined during the period when 'Among Us,' a game where you survive with alien shipmates who attempt to kill the crew, went viral. The term 'Impostor' refers to these aliens.",
  ...
  },
  {
      ...
      "definition": "Refers to someone who is super chill, relaxed, laid back, and cool while being a dreadhead.",
      "examples": []
  },
  {
      "term": "Ohio",
  ...
  },
  {
      "term": "Rizz",
      "definition": [
        "\"Rizz\" is a slang term derived from \"charisma\" that refers to someone's ability to attract or charm others, particularly in romantic or flirty situations.",
  ...
  },
  {
      "term": "Sigma",
      "definition": [
        "The sigma male is often described as a lone wolf, someone who is independent, mysterious, and self-reliant, not conforming to traditional social hierarchies (like the alpha or beta male).",
        "When someone has 'sigma brainrot,' it usually means they are overly absorbed in the idea of this archetype, either humorously adopting the mindset or constantly referencing sigma behaviors in exaggerated ways.",
  ...
  {
      "term": "Unc",
      "definition": "Short for the term uncle. Usually used to refer to someone who is older than you as a way to poke fun at them. (They are usually barely older than you, less than 5 years older.)",
      "examples": [
        "Ok Unc."
      ]
  },
